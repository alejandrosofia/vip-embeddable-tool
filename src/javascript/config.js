module.exports = {
  ...
  "text": {
    ...
    "about": {
      ...
      "content": "The Voting Information Tool is an initiative of the Voting Information Project (VIP), a partnership between state election officials and Democracy Works to connect voters with the election information they need to cast a ballot. Launched in 2008, VIP works with state and local election officials to provide official and up-to-date election information to citizens."
    },
    "footer": {
    ...
    "addressNotFound": {
      ...
      "text": "You entered:<h1>1234 Main St<br>New York, NY 10000</h1>We couldn't find any election information for the address you entered. Please check with your local election official for the most complete and up to date information.",
      "button": "Try Again"
    },
    "mailInVoting": {
